...
export const PianoVisualizer: React.FC<PianoVisualizerProps> = ({ 
  ...
  return (
    <div className="w-full bg-[#0a0f1d] border border-indigo-900/40 rounded-xl p-2 md:p-3 shadow-inner flex flex-col max-lg:landscape:flex-row items-stretch gap-3 md:gap-4 max-lg:landscape:gap-2 relative overflow-hidden backdrop-blur-sm">
      ...
      <div className={`w-full max-lg:landscape:w-[45%] flex-col gap-2 min-w-0 max-lg:landscape:justify-center ${isExpanded ? 'flex' : 'hidden md:flex max-lg:landscape:flex'}`}>
      ...
      <div className="shrink-0 flex flex-col items-center justify-center bg-indigo-950/20 p-2 md:p-3 max-lg:landscape:p-1 rounded-lg border border-indigo-900/40 w-full max-lg:landscape:w-[55%] min-w-0">
